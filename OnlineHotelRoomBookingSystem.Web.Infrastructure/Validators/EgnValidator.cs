namespace OnlineHotelRoomBookingSystem.Web.Infrastructure.Validators;

using System.ComponentModel.DataAnnotations;
using System.Globalization;
using System.Text.RegularExpressions;
public class EgnValidator : ValidationAttribute
{
    private string errorMessage = "{0} is Invalid";
    private readonly int[] weights = new int[] { 2, 4, 8, 5, 10, 9, 7, 3, 6 };
